...
def test_alpha_word_encoding(alpha_fixture):
    assert alpha_fixture.encode() == '0110000101101111000110100010111001011011100010011010100001101'


def test_alpha_string_encoding(alpha_fixture):
    assert str(alpha_fixture) == '00100000010110110000101101111000110100010111001011011100010011010100001101000000'
